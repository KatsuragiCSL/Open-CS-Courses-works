...
function greedy_seam(energies, starting_pixel::Int)
	...
	for r in range(2, m, step = 1)
		...
		for choice in choices
			if energies[r, choice] < minimum
				pick = choice
				minimum = energies[r, choice]
			end
		end
...
function least_energy(energies, i, j)
	...
	minimum, _ = least_energy(energies, i + 1, left)
	pick = left
	for choice in choices
		choice_energy, _ = least_energy(energies, i + 1, choice)
