...
begin
	struct FirstRankOneMatrix
		# Your code here
		FirstRankOneMatrix(a, b) = new(a,b)
		v::Vector{Float64}
		w::Vector{Float64}
	end
...
function print_as_matrix(M::FirstRankOneMatrix)
	...
	# Your code here
	matrix = [x * y for x in M.v, y in M.w]
	print(matrix)
end
...
# ╔═╡ c5e756d1-6d31-46aa-9a73-df71894bcee8
R = RankOneMatrix(collect(1:10))

# ╔═╡ 2a645d00-36f6-443e-b0d6-6939752517f5
collect(1:10)
